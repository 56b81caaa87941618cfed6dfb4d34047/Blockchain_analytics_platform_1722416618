...
Vue.component("purple_feature_grid_component_1722416619", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the curve with our cutting-edge analytics engine that processes new blockchain data in real-time, giving you valuable insights as soon as transactions are confirmed.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Customizable Alerting</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Set up custom alerts to notify you instantly when specific events or conditions occur on the blockchain, ensuring you never miss critical updates relevant to your business.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Gain a deeper understanding of blockchain activity with our powerful data visualization tools, which transform complex datasets into intuitive charts, graphs, and interactive dashboards.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Effortlessly integrate our blockchain analysis platform with your existing systems and workflows through our robust APIs and seamless data export capabilities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Scalable Architecture</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Our distributed and highly scalable infrastructure ensures reliable performance, even during periods of high blockchain activity, providing you with uninterrupted access to critical insights.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Secure and Compliant</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Rest assured that your data is protected with our industry-leading security measures and compliance with the latest regulatory standards for handling blockchain information.</p></div>
        </div>
    </div>`,
        data() {
            return {
