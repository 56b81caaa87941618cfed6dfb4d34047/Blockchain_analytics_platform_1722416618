    ...
    <section id="cta-section-container">
        <nav class="bg-purple-600 p-4">
            <div class="max-w-6xl mx-auto flex justify-between items-center">
                ...
                <div>
                    <a href="#" class="text-white mx-4 hover:text-purple-200">Home</a>
                    <a href="#" class="text-white mx-4 hover:text-purple-200">About</a>
                    <a href="#" class="text-white mx-4 hover:text-purple-200">Contact</a>
                </div>
            </div>
        </nav>
        <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3 text-transparent bg-gradient-to-r from-purple-500 to-purple-200">Harness the Potential of Decentralized Data</div></div>
                    ...
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8 text-slate-400">Stay ahead of the curve with our cutting-edge blockchain analytics platform. Gain actionable insights from the latest blockchain data to drive informed decision-making.</p></div>
