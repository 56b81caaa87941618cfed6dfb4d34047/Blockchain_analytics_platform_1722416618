...
Vue.component("purple_hero_component_1722416619", {
    template: `
        ...
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                ...
                <div class="flex" id="sub-hero-text-container">
                    <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-slate-300" data-aos="fade-down" data-aos-delay="200">Our powerful platform harnesses advanced analytics to decode the complexities of the blockchain, providing you with invaluable intelligence and actionable insights.</p>
                </div>
